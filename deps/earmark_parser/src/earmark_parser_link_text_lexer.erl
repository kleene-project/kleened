...
-module(earmark_parser_link_text_lexer).

-export([string/1,string/2,token/2,token/3,tokens/2,tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("src/earmark_parser_link_text_lexer.xrl", 29).
...
-file("src/earmark_parser_link_text_lexer.erl", 341).
yystate() -> 10.

yystate(11, [33|Ics], Line, Col, Tlen, _, _) ->
    yystate(11, Ics, Line, Col, Tlen+1, 10, Tlen);
yystate(11, [10|Ics], Line, _, Tlen, _, _) ->
    yystate(11, Ics, Line+1, 1, Tlen+1, 10, Tlen);
yystate(11, [C|Ics], Line, Col, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(11, Ics, Line, Col, Tlen+1, 10, Tlen);
yystate(11, [C|Ics], Line, Col, Tlen, _, _) when C >= 11, C =< 31 ->
    yystate(11, Ics, Line, Col, Tlen+1, 10, Tlen);
yystate(11, [C|Ics], Line, Col, Tlen, _, _) when C >= 35, C =< 38 ->
    yystate(11, Ics, Line, Col, Tlen+1, 10, Tlen);
yystate(11, [C|Ics], Line, Col, Tlen, _, _) when C >= 42, C =< 90 ->
    yystate(11, Ics, Line, Col, Tlen+1, 10, Tlen);
yystate(11, [C|Ics], Line, Col, Tlen, _, _) when C >= 94 ->
    yystate(11, Ics, Line, Col, Tlen+1, 10, Tlen);
yystate(11, Ics, Line, Col, Tlen, _, _) ->
    {10,Tlen,Ics,Line,Col,11};
yystate(10, [93|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(8, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(10, [92|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(10, [34|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(3, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(10, [33|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(10, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 11, C =< 31 ->
    yystate(11, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(10, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 35, C =< 38 ->
    yystate(11, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(10, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 42, C =< 90 ->
    yystate(11, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(10, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 94 ->
    yystate(11, Ics, Line, Col, Tlen+1, Action, Alen);
...
yystate(7, [39|Ics], Line, Col, Tlen, _, _) ->
    yystate(9, Ics, Line, Col, Tlen+1, 9, Tlen);
yystate(7, [34|Ics], Line, Col, Tlen, _, _) ->
    yystate(9, Ics, Line, Col, Tlen+1, 9, Tlen);
yystate(7, [32|Ics], Line, Col, Tlen, _, _) ->
    yystate(7, Ics, Line, Col, Tlen+1, 9, Tlen);
yystate(7, Ics, Line, Col, Tlen, _, _) ->
    {9,Tlen,Ics,Line,Col,7};
yystate(6, [C|Ics], Line, Col, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(4, Ics, Line, Col, Tlen+1, 8, Tlen);
yystate(6, [C|Ics], Line, Col, Tlen, _, _) when C >= 11 ->
    yystate(4, Ics, Line, Col, Tlen+1, 8, Tlen);
...
-file("src/earmark_parser_link_text_lexer.xrl", 15).
yyaction_0(TokenChars, TokenLine) ->
     { token, { escaped, TokenLine, dismiss_backslash (TokenChars) } } .

-compile({inline,yyaction_1/2}).
-file("src/earmark_parser_link_text_lexer.xrl", 16).
yyaction_1(TokenChars, TokenLine) ->
     { token, { exclamation_mark, TokenLine, TokenChars } } .

-compile({inline,yyaction_2/2}).
-file("src/earmark_parser_link_text_lexer.xrl", 17).
yyaction_2(TokenChars, TokenLine) ->
     { token, { open_paren, TokenLine, TokenChars } } .

-compile({inline,yyaction_3/2}).
-file("src/earmark_parser_link_text_lexer.xrl", 18).
yyaction_3(TokenChars, TokenLine) ->
     { token, { close_paren, TokenLine, TokenChars } } .

-compile({inline,yyaction_4/2}).
-file("src/earmark_parser_link_text_lexer.xrl", 19).
yyaction_4(TokenChars, TokenLine) ->
     { token, { open_bracket, TokenLine, TokenChars } } .

-compile({inline,yyaction_5/2}).
-file("src/earmark_parser_link_text_lexer.xrl", 20).
yyaction_5(TokenChars, TokenLine) ->
     { token, { close_bracket, TokenLine, TokenChars } } .

-compile({inline,yyaction_6/2}).
-file("src/earmark_parser_link_text_lexer.xrl", 21).
yyaction_6(TokenChars, TokenLine) ->
     { token, { open_title, TokenLine, TokenChars } } .

-compile({inline,yyaction_7/2}).
-file("src/earmark_parser_link_text_lexer.xrl", 22).
yyaction_7(TokenChars, TokenLine) ->
     { token, { any_quote, TokenLine, TokenChars } } .

-compile({inline,yyaction_8/2}).
-file("src/earmark_parser_link_text_lexer.xrl", 23).
yyaction_8(TokenChars, TokenLine) ->
     { token, { verbatim, TokenLine, TokenChars } } .

-compile({inline,yyaction_9/2}).
-file("src/earmark_parser_link_text_lexer.xrl", 24).
yyaction_9(TokenChars, TokenLine) ->
     { token, { ws, TokenLine, TokenChars } } .

-compile({inline,yyaction_10/2}).
-file("src/earmark_parser_link_text_lexer.xrl", 25).
yyaction_10(TokenChars, TokenLine) ->
     { token, { verbatim, TokenLine, TokenChars } } .
