...
-module(earmark_parser_string_lexer).

-export([string/1,string/2,token/2,token/3,tokens/2,tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("src/earmark_parser_string_lexer.xrl", 13).
...
-file("src/earmark_parser_string_lexer.erl", 339).
yystate() -> 2.

yystate(3, [10|Ics], Line, _, Tlen, _, _) ->
    yystate(3, Ics, Line+1, 1, Tlen+1, 0, Tlen);
yystate(3, [C|Ics], Line, Col, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(3, Ics, Line, Col, Tlen+1, 0, Tlen);
yystate(3, [C|Ics], Line, Col, Tlen, _, _) when C >= 11, C =< 91 ->
    yystate(3, Ics, Line, Col, Tlen+1, 0, Tlen);
yystate(3, [C|Ics], Line, Col, Tlen, _, _) when C >= 93, C =< 95 ->
    yystate(3, Ics, Line, Col, Tlen+1, 0, Tlen);
yystate(3, [C|Ics], Line, Col, Tlen, _, _) when C >= 97 ->
    yystate(3, Ics, Line, Col, Tlen+1, 0, Tlen);
yystate(3, Ics, Line, Col, Tlen, _, _) ->
    {0,Tlen,Ics,Line,Col,3};
yystate(2, [96|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(0, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(2, [92|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(2, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 11, C =< 91 ->
    yystate(3, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(2, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 93, C =< 95 ->
    yystate(3, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(2, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 97 ->
    yystate(3, Ics, Line, Col, Tlen+1, Action, Alen);
...
-file("src/earmark_parser_string_lexer.xrl", 7).
yyaction_0(TokenChars, TokenLine) ->
     { token, { other, TokenLine, TokenChars } } .

-compile({inline,yyaction_1/2}).
-file("src/earmark_parser_string_lexer.xrl", 8).
yyaction_1(TokenChars, TokenLine) ->
     { token, { escape, TokenLine, TokenChars } } .

-compile({inline,yyaction_2/2}).
-file("src/earmark_parser_string_lexer.xrl", 9).
yyaction_2(TokenChars, TokenLine) ->
