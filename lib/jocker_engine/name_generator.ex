defmodule Jocker.Engine.NameGenerator do
  def new() do
    ...
    names = name_list()
    random_adjective = elem(adjectives, :rand.uniform(tuple_size(adjectives) - 1))
    random_name = elem(names, :rand.uniform(tuple_size(names) - 1))
    "#{random_adjective}_#{random_name}"
  end
